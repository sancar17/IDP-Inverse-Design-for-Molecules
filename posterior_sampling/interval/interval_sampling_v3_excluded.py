...
def main():
    ...
    analysis_dir = './point_sampling_results_excluded_v3_model/'
    # Load dataset for statistics
    entire_data = pd.read_csv('../../data/excluded1_qm9_smiles_prop_normalized.csv')
    data_path = '../../data/excluded1_qm9_smiles_prop_normalized.csv'
    ...
    model = JTNNVAE_joint(vocab, 450, 56, 20, 3, property_weight=1, z_prop_size=14)
